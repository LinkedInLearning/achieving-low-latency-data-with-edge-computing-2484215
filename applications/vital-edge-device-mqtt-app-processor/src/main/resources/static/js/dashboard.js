...
{
  var vitalChart = window[vitalSign.statName+"Chart"+vitalSign.vitalId];
   if (typeof vitalChart !== 'undefined')
   {
        addData(vitalChart,vitalSign.label,vitalSign.value);
   }
   else
   {
      console.log("ERROR: CHART NOT FOUND with ID="+vitalSign.statName+"Chart"+vitalSign.vitalId)
   }
...
function removeFirstDataOld(chart) {
